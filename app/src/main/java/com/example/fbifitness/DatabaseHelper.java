...
public class DatabaseHelper extends SQLiteOpenHelper implements Config {
    ...
    static final String DROP_TABLES =
            "DROP TABLE IF EXISTS " + LOGIN_TABLE + "; " + // TODO IDE Error Does not impact code
            "DROP TABLE IF EXISTS " + AUTH_TABLE + "; " +  // TODO IDE Error Does not impact code
    ...
    static final String CREATE_LOCAL_LOGIN_TABLE_QUERY =
            "DROP TABLE IF EXISTS " + LOGIN_TABLE + "; " + // TODO Remove before production
    ...
    static final String CREATE_LOCAL_AUTH_TABLE_QUERY =
            "DROP TABLE IF EXISTS " + AUTH_TABLE + "; " + // TODO Remove before production
    ...
    static final String CREATE_LOCAL_USER_TABLE_QUERY =
            "DROP TABLE IF EXISTS " + USER_TABLE + "; " + // TODO Remove before production
    ...
    static final String CREATE_LOCAL_WORKOUT_TABLE_QUERY =
            "DROP TABLE IF EXISTS " + WORKOUT_TABLE + "; " + // TODO Remove before production
    ...
    static final String CREATE_LOCAL_EXERCISE_TABLE_QUERY =
            "DROP TABLE IF EXISTS " + EXERCISE_TABLE + "; " + // TODO Remove before production
    ...
    static final String CREATE_LOCAL_SET_TABLE_QUERY =
            "DROP TABLE IF EXISTS " + SET_TABLE + "; " + // TODO Remove before production
    ...
    static final String CREATE_LOCAL_EXERCISE_TYPE_TABLE_QUERY =
            "DROP TABLE IF EXISTS " + EXERCISE_TYPE_TABLE + ";" + // TODO Remove before production
    ...
    public void onCreate(SQLiteDatabase db) {
        String createQuery =
                CREATE_LOCAL_AUTH_TABLE_QUERY +
                CREATE_LOCAL_LOGIN_TABLE_QUERY +
                CREATE_LOCAL_USER_TABLE_QUERY +
                CREATE_LOCAL_WORKOUT_TABLE_QUERY +
                CREATE_LOCAL_EXERCISE_TABLE_QUERY +
                CREATE_LOCAL_SET_TABLE_QUERY +
                CREATE_LOCAL_EXERCISE_TYPE_TABLE_QUERY;
